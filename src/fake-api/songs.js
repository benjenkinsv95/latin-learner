  ...
  return Promise.resolve({
    data: {
      songs: [
        ...
        {
          type: 'song',
          _id: '61ca20440666437f25d385c7',
          name: 'Learning Latin Greetings: Hello! Goodbye! Salvē! Valē!',
          artist: 'Beatles',
        ...
        {
          type: 'song',
          _id: '61c978d538a4015a8c500b48',
          name: 'Aeneid 1.1-11 in meter, with synth',
          artist: 'Publius Vergilius Maro',
          youtubeChannel: 'HI PAWS',
        ...
        {
          type: 'song',
          _id: '61ca2b1b7ea33d874e0424ed',
          name: 'Hellfire',
          artist: 'ScorpioMartianus',
          youtubeChannel: 'ScorpioMartianus',
...
export const getSongById = (id) => {
  return getSongs()
    .then(response => response.data.songs.find(song => song._id === id))
    .then(song => Promise.resolve({
      data: { song }
    }))
}
